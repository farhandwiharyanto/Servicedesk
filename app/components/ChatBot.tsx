...
export function ChatBot() {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      let botText = "Mohon maaf, saya masih dalam tahap pelatihan. Anda bisa mencoba menu IT Portal atau HR Portal untuk bantuan lebih lanjut.";
      
      const lower = userMsg.text.toLowerCase();
      if (lower.includes('it') || lower.includes('komputer') || lower.includes('wifi')) {
        botText = "Untuk masalah teknis seperti itu, silakan kunjungi IT Portal. Kami bisa membantu perbaikan perangkat keras maupun jaringan.";
      } else if (lower.includes('hr') || lower.includes('cuti') || lower.includes('gaji')) {
        botText = "Terkait kebijakan karyawan atau payroll, Anda bisa langsung mengakses HR Portal.";
      }
